...
try {
    ...
    if ($driver === 'pgsql') {
        $sqlFile = __DIR__ . '/script_creacion_pgsql.sql';
    } elseif ($driver === 'mysql') {
        $sqlFile = __DIR__ . '/script_creacion_mysql.sql';
    } else {
        $sqlFile = __DIR__ . '/script_creacion.sql';
    }
    ...
    echo json_encode([
        "status" => "success",
        "message" => "¡Base de datos inicializada correctamente en la nube!",
